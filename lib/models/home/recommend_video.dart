...
class RecommendVideoResponse {
  ...
  factory RecommendVideoResponse.fromRawJson(String str) => RecommendVideoResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory RecommendVideoResponse.fromJson(Map<String, dynamic> json) => RecommendVideoResponse(
        code: json["code"],
        message: json["message"],
        ttl: json["ttl"],
        data: json["data"] == null ? null : RecommendVideoResponseData.fromJson(json["data"]),
      );
...
class RecommendVideoResponseData {
  ...
  factory RecommendVideoResponseData.fromRawJson(String str) => RecommendVideoResponseData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory RecommendVideoResponseData.fromJson(Map<String, dynamic> json) => RecommendVideoResponseData(
        item: json["item"] == null
            ? []
            : List<RecommendVideoResponseItem>.from(json["item"]!.map((x) => RecommendVideoResponseItem.fromJson(x))),
...
class RecommendVideoResponseItem {
  ...
  factory RecommendVideoResponseItem.fromRawJson(String str) => RecommendVideoResponseItem.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory RecommendVideoResponseItem.fromJson(Map<String, dynamic> json) => RecommendVideoResponseItem(
        id: json["id"],
        bvid: json["bvid"],
        cid: json["cid"],
        goto: json["goto"],
...
class RcmdReason {
  ...
  factory RcmdReason.fromRawJson(String str) => RcmdReason.fromJson(json.decode(str));
