class ApiConstants {
  ...
  ///动态页Up主面板
  static const String dynamicAuthorList =
      "$apiBase/x/polymer/web-dynamic/v1/portal";
  ...
  ///
  ///[rid] 分区 id
  static const String regionUrl = "$apiBase/x/web-interface/dynamic/region";
  ...
  ///
  ///[pn] 刷新次数
  static const String rankHitUrl =
      "$apiBase/audio/music-service-c/web/menu/hit";
  ...
  ///[order] 排序
  ///
  ///[test] https://api.bilibili.com/x/v3/fav/resource/list?media_id=2380650383&pn=1&ps=20&keyword=&order=mtime&type=0&tid=0&platform=web
  static const String favResourceList = "$apiBase/x/v3/fav/resource/list";

  ///收藏夹详情
  ///
  ///[media_id] 收藏夹 ID
  ///
  static const String favFolderDetail = '$apiBase/x/v3/fav/folder/info';
  ...
  ///
  ///[rid] 分区id
  static const String rankingRegion = '$apiBase/x/web-interface/ranking/region';

  /// 获取全部收藏夹列表
  ///
  static const String favFolderListAll =
      '$apiBase/x/v3/fav/folder/created/list-all';

  /// 获取音乐区首页轮播图
  ///
  static const String swipeDataUrl =
      '$apiBase/x/web-show/res/locs?pf=0&ids=4979';
  ...
  /// [plaform] 固定 web
  ///
  static const String collectListUrl =
      '$apiBase/x/v3/fav/folder/collected/list';

  ///获取收藏列表内容
  ///
  ///实例：https://api.bilibili.com/x/space/fav/season/list?season_id=1393633&pn=1&ps=20
  ///
  ///[season_id] 收藏夹 id
  ///
  ///[pn] 页码
  ...
  ///[ps] 每页内容数量
  ///
  static const String collectListMediasUrl = '$apiBase/x/space/fav/season/list';

  /// 新的获取字幕接口
  /// 实例：https://api.bilibili.com/x/player/wbi/v2?aid=473631179&cid=850040529
  ///
  /// [aid] 视频 aid
  ///
  /// [cid] 视频 cid
  ...
  /// [bvid] 视频 bvid
  ///
  static const String newSubtitleUrl = '$apiBase/x/player/wbi/v2';

  /// 获取个人信息
  ///
  /// [mid] 用户 id
  ///
  static const String userInfoUrl = '$apiBase/x/space/wbi/acc/info';

  /// 用户名片
  /// 实例：https://api.bilibili.com/x/web-interface/card?mid=256801023
  /// [mid] 用户 id
  static const String userCardUrl = '$apiBase/x/web-interface/card';

  /// 查询用户投稿
  /// 实例 https://api.bilibili.com/x/space/wbi/arc/search?mid=256801023&pn=1&ps=20
  ///
  /// [mid] 用户 id
  ///
  /// [pn] 页码
  ...
  /// [ps] 每页数量
  ///
  static const String userVideosUrl = '$apiBase/x/space/wbi/arc/search';
}
